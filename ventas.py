...
with tab_calculadora:
    ...
    with cC:
        ...
        st.session_state.rell_enabled = st.checkbox("Rellenado", value=bool(st.session_state.rell_enabled), key="rell_enabled")
        st.session_state.rell_t_input = st.number_input("Tiempo/ud Rellenado", min_value=0.0, value=float(st.session_state.rell_t_input), step=1.0, key="rell_t_input", disabled=not bool(st.session_state.rell_enabled))
        st.session_state.arm_enabled = st.checkbox("Armado", value=bool(st.session_state.arm_enabled), key="arm_enabled")
        st.session_state.arm_t_input = st.number_input("Tiempo/ud Armado", min_value=0.0, value=float(st.session_state.arm_t_input), step=1.0, key="arm_t_input", disabled=not bool(st.session_state.arm_enabled))
